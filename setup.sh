...
echo "       source ~/.zshrc"
echo ""
echo "  2. Grant Terminal → Accessibility (to control NordVPN):"
echo "       System Settings → Privacy & Security → Accessibility → Terminal → ON"
echo ""
echo "  3. Grant Terminal → Location Services (to read Wi-Fi SSID on macOS Sequoia):"
echo "       System Settings → Privacy & Security → Location Services"
echo "       → scroll down to Terminal → set to 'While Using'"
echo "       (Required for trusted-network detection to work)"
echo ""
echo "Then verify everything works:"
echo "  nordvpn-helper diagnose"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
